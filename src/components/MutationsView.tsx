      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-success-50 to-success-100/50 rounded-xl shadow-card p-6 border border-success-100/80">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-success-600">Total Kredit</p>
        ...
        <div className="bg-gradient-to-br from-danger-50 to-danger-100/50 rounded-xl shadow-card p-6 border border-danger-100/80">
          <div className="flex items-center">
            <div className="p-3 bg-gradient-to-br from-danger-500 to-danger-600 rounded-xl shadow-sm">
              <TrendingDown className="w-6 h-6 text-white" />
            </div>
            <div className="ml-4">
              <p className="text-sm font-medium text-danger-600">Total Debit</p>
              <p className="text-2xl font-bold text-neutral-800">
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center px-4 py-2 bg-success-600 text-white rounded-lg hover:bg-success-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors"
          >
