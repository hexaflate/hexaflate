    ...
    >
      ...
      {hasValidationErrors && showValidationErrors && (
        <div className="absolute top-2 left-2">
          <div className="bg-danger-500 text-white text-xs px-2 py-1 rounded">
            ⚠️ Error
          </div>
        </div>
      )}
      ...
      {banner.clonedFromMenuId && (
        <div className="absolute bottom-2 left-2">
          <div className="text-white text-xs px-2 py-1 rounded" style={{ backgroundColor: withOpacity(THEME_COLOR, 0.75) }}>
            Cloned from Menu
          </div>
        </div>
      )}
