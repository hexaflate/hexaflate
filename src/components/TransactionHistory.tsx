...
const TransactionHistory: React.FC<TransactionHistoryProps> = ({ authSeed }) => {
  ...
  const handleCSVExport = async (startDate: string, endDate: string) => {
    try {
      ...
      setExportErrorMessage('Gagal mengekspor data: ' + (error as Error).message);
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-11 pr-4 py-2.5 bg-white/80 backdrop-blur-sm border border-neutral-200/80 rounded-xl focus:ring-2 focus:ring-success-500/20 focus:border-success-400 transition-all duration-200"
            />
          </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center px-4 py-2.5 bg-gradient-to-r from-success-500 to-success-600 text-white rounded-xl hover:from-success-600 hover:to-success-700 focus:ring-2 focus:ring-success-500/30 focus:ring-offset-2 transition-all duration-200 font-medium shadow-sm"
            >
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-card overflow-hidden border border-neutral-100/80">
        <div className="px-6 py-4 border-b border-neutral-100 flex items-center justify-between bg-gradient-to-r from-neutral-50/50 to-white">
          ...
          <button
            ...
            className="flex items-center px-4 py-2 bg-gradient-to-r from-success-500 to-success-600 text-white rounded-xl hover:from-success-600 hover:to-success-700 focus:ring-2 focus:ring-success-500/30 focus:ring-offset-2 transition-all duration-200 font-medium shadow-sm"
          >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <button
                        ...
                        className="mt-2 flex items-center px-3 py-1.5 text-sm bg-primary-600 text-white rounded-lg hover:bg-primary-700 focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {isLoadingDetails ? (
                          <>
        ...
        {pagination.has_next && (
          <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 bg-success-600 text-white rounded-lg hover:bg-success-700 focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoadingMore ? (
                <>
              ...
              {detailsError ? (
                <div className="bg-danger-50 border border-danger-200 rounded-lg p-4">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-danger-800">Error</h3>
                      <p className="text-sm text-danger-700 mt-1">{detailsError}</p>
                    </div>
                  </div>
                </div>
              ) : selectedTransaction ? (
