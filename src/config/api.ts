...
// Token value
export const X_TOKEN_VALUE = domainConfig.xTokenValue || "";

// Event listeners for 401 unauthorized responses
...
/**
 * Check if a response is a 401 unauthorized and trigger callbacks if so
